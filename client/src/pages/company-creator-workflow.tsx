    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-6">
        <TabsList className="flex w-full items-center justify-start gap-6 border-b border-border bg-transparent p-0 sm:w-auto">
          <TabsTrigger
            value="videos"
            className="relative h-auto rounded-none bg-transparent px-0 pb-3 text-sm font-medium text-muted-foreground data-[state=active]:bg-transparent data-[state=active]:text-foreground data-[state=active]:after:absolute data-[state=active]:after:left-0 data-[state=active]:after:top-full data-[state=active]:after:block data-[state=active]:after:h-0.5 data-[state=active]:after:w-full data-[state=active]:after:bg-primary"
          >
            Promotional Videos
          </TabsTrigger>
          <TabsTrigger
